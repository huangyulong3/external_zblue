 ...
 *
 * LLL advertising PDU stub for NuttX port
 */

#ifndef LLL_LLL_ADV_PDU_H_
#define LLL_LLL_ADV_PDU_H_

#include <stdint.h>
#include "lll_adv_types.h"

/* PDU memory size definitions */
...
/* Function declarations - implemented in lll_stub.c */
